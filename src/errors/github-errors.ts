...
export class GitHubNotFoundError extends GitHubError {
  constructor(content?: string) {
    super(
      ...
      content ?? 'The requested GitHub repository could not be found.',
    );
  }
}
...
export class GitHubRateLimitError extends GitHubError {
  constructor(content?: string) {
    super(
      ...
      content ?? 'You have exceeded the GitHub API rate limit.',
    );
  }
}
...
export class GitHubBadCredentialsError extends GitHubError {
  constructor(content?: string) {
    super(
      ...
      content ?? 'The provided GitHub credentials are invalid.',
    );
  }
}
...
export class GitHubAccountSuspendedError extends GitHubError {
  constructor(content?: string) {
    super(
      ...
      content ?? 'The GitHub account has been suspended.',
    );
  }
}
...
export class GitHubUsernameNotFoundError extends GitHubError {
  constructor(content?: string) {
    super(
      ...
      content ?? 'The requested GitHub username could not be found.',
    );
  }
}
